...
def analyze_image(base64_image):
    ...
    1. Analyseer de ONDERGROND: Is het glad stucwerk? Baksteen? Hout? Behang?
    2. Schat de AFMETINGEN: Kijk naar referentiepunten.
    3. Bereken de OPPERVLAKTE (Hoogte x Breedte).
    4. Bepaal de VERF SPUITBAARHEID: Ruwe muren zuigen meer verf op.
    ...
    * **Ondergrond:** [Wat zie je?]
    * **Conditie:** [Schoon of voorbehandeling nodig?]
    
    ### 📏 De Berekening
    * **Geschatte afmetingen:** [Hoogte]m x [Breedte]m
    * **Netto Oppervlak:** [Aantal] m2
    * **Benodigde Verf:** [Aantal] Liter
    * **Kostenindicatie:** € [Bedrag]
    
    ### 🛒 Boodschappenlijst
    * **Verf:** [Type verf advies]
    * **Roller:** [Advies roller]
    * **Voorstrijk:** [JA/NEE]
    * **Tape:** [Type tape]
